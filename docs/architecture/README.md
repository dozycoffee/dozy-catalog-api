...
| 인증·인가 방식 | 토큰은 별도 시스템이 발급하고 Catalog는 검증만 한다. 토큰 형식, 역할·매장 클레임, 401/403 응답 형식은 dozy-wms-api와 함께 정한다. API의 경로별 인가 범위는 [API 명세](../api/README.md#경로와-인가)에 있다 | [기술 스택](tech-stack.md), [API 명세](../api/README.md) |
